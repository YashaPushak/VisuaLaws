    ...
    Tipsy.prototype = {
        show: function() {
            ...
            if (this.enabled && (title = this.getTitle())) {
				...
				if(gravity.length == 2 && gravity.charAt(1) == 'r' || gravity.length == 3 && gravity.charAt(2) == 'r'){
					
					var pos = $.extend({}, $("rect#" + this.$element.context.__data__.key).offset() );
					pos = $.extend(pos, $("rect#" + this.$element.context.__data__.key)[0].getBBox() );
					
					//yasha
					gravity = gravity.substring(0,2);
